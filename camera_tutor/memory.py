...
# Default storage directory (CAMERA_TUTOR_DATA_DIR can override)
DEFAULT_STORAGE_DIR = str(data_dir())
...
class ConversationMemory:
    ...
    When user_id is provided, data is stored under:
        .camera-tutor-data/{user_id}/stats.json
        .camera-tutor-data/{user_id}/sessions/session_*.json
